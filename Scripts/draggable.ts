...
namespace Draggale {
    ...
    let closet = (element: HTMLElement, className: string) => {
    ...
    export function init(parent: HTMLElement = document.documentElement) {
        let draggables = parent.getElementsByClassName("element-draggable");
        ...
        let dropzones = parent.getElementsByClassName("element-dropzone");
